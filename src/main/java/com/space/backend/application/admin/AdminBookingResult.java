// src/main/java/com/space/backend/application/admin/AdminBookingResult.java
...
public record AdminBookingResult(
        UUID id,
        UUID userId,
        String userName,
        UUID spaceId,
    ...
    public static AdminBookingResult from(Booking b) {
        return new AdminBookingResult(
                b.getId(),
                b.getUser().getId(),
                b.getUser().getName(),
                b.getSpace().getId(),
